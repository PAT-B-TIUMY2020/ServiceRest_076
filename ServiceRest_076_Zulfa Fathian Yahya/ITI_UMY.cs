...
namespace ServiceRest_076_Zulfa_Fathian_Yahya
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_076_Zulfa_Fathian_Yahya.ContractType".
    [DataContract]
